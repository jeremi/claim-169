...
Complete API documentation for the `claim169-core` crate.
...
The main identity data structure.
...
## Software Crypto (feature: software-crypto)

Available when the `software-crypto` feature is enabled (default).
